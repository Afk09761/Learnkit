...
window.addEventListener('beforeinstallprompt', e => {
  ...
  setTimeout(() => {
    ...
    `;
    banner.style.cssText = 'position:fixed;bottom:calc(1.5rem + env(safe-area-inset-bottom, 0px));left:1rem;right:1rem;max-width:420px;margin-left:auto;margin-right:auto;background:var(--cream);border:1px solid var(--sand);border-radius:var(--radius-xl);padding:1rem 1.3rem;box-shadow:var(--shadow-deep);z-index:9000;color:var(--ink);font-family:var(--font-body);box-sizing:border-box;';
